                  ...
                  <ul>
                    ...
                    <li className="submenu-open">
                      ...
                      <ul>
                        ...
                        <li
                          className={
                            pathname.includes("addproduct-product")
                              ? "active"
                              : ""
                          }
                        >
                        ...
                        <li
                          className={
                            pathname.includes("brandlist-product")
                              ? "active"
                              : ""
                          }
                        >
                        ...
                        >
                          <Link
                            className={
                              pathname.includes("importproduct-")
                                ? "active"
                                : ""
                            }
                    ...
                    <li className="submenu-open">
                      ...
                      <ul>
                        ...
                        >
                          <Link
                            className={
                              pathname.includes("quotationlist-")
                                ? "active"
                                : ""
                            }
                    ...
                    <li className="submenu-open">
                      ...
                      <ul>
                        ...
                        <li
                          className={
                            pathname.includes("storelist-people")
                              ? "active"
                              : ""
                          }
                        >
                    ...
                    <li className="submenu-open">
                      ...
                      <ul>
                        ...
                        <li
                          className={
                            pathname.includes("blankpage") ? "active" : ""
                          }
                        >
                          <Link
